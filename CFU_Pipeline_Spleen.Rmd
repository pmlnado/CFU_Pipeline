...
path <- c("/Volumes/rstor-henao_lab/Pablo/CFU_Pipeline/IMPACTB_CFU_Op1_D56_Spleen.xlsx")
...
geom_point(size = 5, shape = 21, alpha = 0.8, na.rm = T, colour = "black", 
  ...
  geom_boxplot(aes(fill = group), alpha = 0.3) + facet_wrap(~ sex) + 
...
labs (y="Log10 CFU") +
  ggtitle("Spleen D56 Option 1 CFU") +
  ylim(3.7, 5.5)
