...
path <- c("/Volumes/rstor-henao_lab/Pablo/CFU_Pipeline/IMPAcTB_Lung_Base/IMPACTB_CFU_Base_AllDays_Lung.xlsx")
...
lungbasetidy_cfu_meta_joined  <- inner_join(meta, tidy_cfu_data) %>%
  group_by(group) %>% 
...
lungbasetidy_cfu_meta_joined

write.csv(lungbasetidy_cfu_meta_joined, "lungbasetidy_cfu_meta_joined.csv", row.names = FALSE)
