...
all_data$group = factor(all_data$group, levels = c("Saline",
            "BCG 1x", "BCG + SolaVAX-IM-CpG 2x", "BCG + SolaVAX-IM-CpG + SolaVAX-IN-CPG", "BCG + SolaVAX-IM-AdVAX 2x", "BCG + SolaVAX-IM-AdVAX + SolaVAX-IN-AdVAX", "BCG + SolaVAX-IN-Laporte 2x", "BCG 2x"))
...
#   filter(!(mouse == "D" & group == "BCG + SolaVAX-IM-CpG + SolaVAX-IN-CPG"))
# 
# tidy_cfu_meta_joined  <- tidy_cfu_meta_joined %>%
...
labs (y="Log10 CFU", fill = "Vaccine") +
  ggtitle("SolaVAX-TB 2x Boost Day 30 CFU") +
  ylim(4.5, 6)
